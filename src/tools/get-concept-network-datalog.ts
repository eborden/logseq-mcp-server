...
import { ConceptNetworkResult } from './get-concept-network-http.js';
import { DatalogQueryBuilder } from '../datalog/queries.js';

/**
 * Get network of pages related to a concept (Datalog implementation)
 ...
 */
export async function getConceptNetworkDatalog(
  client: LogseqClient,
  conceptName: string,
  maxDepth: number = 2
